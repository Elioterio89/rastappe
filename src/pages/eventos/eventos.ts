...
export class EventosPage {
  ...
  constructor(public navCtrl: NavController,
    ...
    this.eventos = new Array(
      ...
      '20181005 22H','Espaço Villa-Eunapolis(BA)','oXarope',
      ...
      '20180503 15h','Coliseu do forro-Salvador(BA)','Coliseu do forro',
      '20R$',
      'Local do evento','coliseudoforro.com',
      '',
      'Villea Convida'),
      new Evento('../../assets/imgs/eventos/7.png',7,'Trio dona Zefa + DJ Edu RQ',
      '201800526 23h','Forro Brasil-São Paulo(SP)','Forro Brasil',
      '40R$',
      ...
      '20181213 20hrs','Minas Brasilia Tenis Clube-Brasilia(DF)','Raizes do Sertão',
      '40R$',
      'Sympla/Local do evento','raizesdosertao@gmail.com',
      '2 Ambientes',
      ''),
      new Evento('../../assets/imgs/eventos/9.png',9,'Raizes forro club + DJ Paulo Andre',
     '20180523 20hrs','Portela Cafe-Salvador(BA)','Quarta Forro Club',
      ...
      '20180916 11hrs','Chacara Asa branca-Vila do Abrantes(BA)','1Tonelada de Forro',
      ...
      '20180923 19:30hrs','Chacara Asa branca-Vila do Abrantes(BA)','1Tonelada de Forro',
