...
export class EventosPage  {
  ...
  slideEventos(){
    ...
    this.itensSlide = new Array(
      ...
      'Venha curtir a ressaca do são Joao',new Favorito(false))
      ,
      ...
      'Peeense num salão chameguento! Se achegue sexta, às 23h, lá no @mirantedosaflitos #forródagota #meunorte #mirantedosaflitos #pensenumralabuchobom #forró #forróemsalvador #forróbaiano #forródabahia @hedernovaes',new Favorito(false))
      ,
  ...
  listaEventos(){
    this.eventos = [
      ...
      '',
      'Forro dos guardiões apresenta :TRIO CARUÁ',new Favorito(false))
      },
      ...
      'Lançameto do album A ORIGEM O AGORA E O FUTURO ',new Favorito(false))},
      ...
      'Arraia da vila ,primeira festa oficial do sao joão na bahia',new Favorito(false))},
      ...
      'Pela primeira vez em Eunapolis',new Favorito(false))},
      ...
      '',
      'Villea Convida',new Favorito(false))},
      ...
      '',
      'Forro Brasil Apresenta',new Favorito(false))},
      ...
      'All Inclusive',
      'Esquente para o #1toneladadeforro',new Favorito(false))},
